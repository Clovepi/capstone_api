...
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://rueqmgjeyqanwl:c14208eba3f507229fccb340274f86a52efa1779a69c4503710246f985da25d9@ec2-52-3-2-245.compute-1.amazonaws.com:5432/d8t6vnl66onjhg"
db = SQLAlchemy(app)
ma = Marshmallow(app)
